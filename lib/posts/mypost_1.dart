...
class MyPost1 extends StatelessWidget {
  ...
  MyPost1({required this.pokemonName});

  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _apiService.getBulbasaur('1'), // O el ID del Pokémon que deseas obtener
      builder: (context, AsyncSnapshot<Bulbasaur?> snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Scaffold(
            backgroundColor: Color.fromARGB(220, 15, 224, 27),
            body: Stack(
              children: [
                //WHITE BOX CONTAINER
                Positioned(
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                        color: Color.fromARGB(220, 15, 224, 27),
                                        borderRadius: BorderRadius.circular(5)),
                                    child: const Center(
                                      child: Text(
                                        'HP',
                ...
                Positioned(
                  ...
                  right: 35,
                  child: FutureBuilder(
                    future: _apiService.fetchBulbasaurImage('bulbasaur'),
                    builder: (context, AsyncSnapshot<String?> snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        return CircularProgressIndicator(); //carga
                      } else if (snapshot.hasError) {
                        return Text('Error: ${snapshot.error}');
                      } else if (snapshot.hasData) {
